...
public class DomainDetailFragment extends AbstractDetailsFragment implements SizedFragmentPage {
	...
	protected void showHosts() {
		mListener.onItemSelected(parent, HostsFragment_.class) ;
	}
	...
	protected void updateDomain() {
		...
		try {
			Domain result = client.postObject(Domain.class, requested, "/domains/"+parent.getId()+"/") ;
